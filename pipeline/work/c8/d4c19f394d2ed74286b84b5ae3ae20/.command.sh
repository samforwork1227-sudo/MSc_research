...
J1=$(sbatch --parsable /cephfs/volumes/hpc_data_usr/k25053715/3a800abf-2370-46d6-96d9-b8284b670110/MSc_research/nextflow/2_pipeline/015_fgfr1/1_protein_min.sh "$CLEAN_PDB_PATH")
