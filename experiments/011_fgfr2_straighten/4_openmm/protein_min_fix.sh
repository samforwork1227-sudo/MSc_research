...
INPUT_PDB="/scratch/users/k25053715/MSc_research/2_biopython_project/2_straighten/013_straighten/FGFR2_clean_linkers.pdb"

cp "$INPUT_PDB" ./FGFR2_clean_linkers.pdb
echo "Copied: $INPUT_PDB → ./FGFR2_clean_linkers.pdb"
...
fixer = pdbfixer.PDBFixer(filename='FGFR2_clean_linkers.pdb')
...
openmm.app.PDBFile.writeFile(fixer.topology, fixer.positions, open('013_1_clean_fixed.pdb', 'w'))

############################################
# Step 2: Forcefield + hydrogens
############################################

pdb = openmm.app.PDBFile('013_1_clean_fixed.pdb')
...
openmm.app.PDBFile.writeFile(modeller.topology, modeller.positions, open('013_2_clean_withH.pdb', 'w'))
...
openmm.app.PDBFile.writeFile(
    simulation.topology,
    positions,
    open('013_3_fgfr2_clean_minimized.pdb', 'w')
)
...
echo "Results:"
ls -lh 013_*.pdb FGFR2_clean_linkers.pdb
echo "Copy back: cp 013_3_fgfr2_clean_minimized.pdb /your/working/dir/"
